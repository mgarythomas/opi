  ...
  <xsl:template match="/">
    <fo:root>
      ...
      <fo:layout-master-set>
        <fo:simple-page-master master-name="FormB" page-height="297mm" page-width="210mm" margin-top="0mm" margin-bottom="0mm" margin-left="0mm" margin-right="0mm">
      ...
      <!-- 
        - This page-secquence is for Form B - The grey pages.
        -
        -->
      <fo:page-sequence master-reference="FormB" force-page-count="no-force">
          ...
          <fo:table padding-after="5px" border-collapse="collapse">
            ...
            <fo:table-body>
              ...
              <fo:table-row>
                ...
                <fo:table-cell padding-top="3px" padding-bottom="3px" border-bottom="thick solid black">
                  <fo:block font-size="11pt" margin-right="10px" text-align="center">$1.00 US</fo:block>
                </fo:table-cell>
                <fo:table-cell padding-top="3px" padding-bottom="3px" border-bottom="thick solid black">
                  <fo:block font-size="11pt" margin-right="10px" text-align="center">
                    $<xsl:value-of select="format-number($totalInvestmentAmount, '#,##0')"/> US
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell padding-top="3px" padding-bottom="3px" border-bottom="thick solid black">
                  <fo:block font-size="11pt" margin-right="10px" text-align="center">
