...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    <title>OPI - Create Adviser</title>
  ...
  <body>
    <div id="wrapper">
      ...
      <div id="content">
        ...
        <div class="info-box">
          <p class="normal">
            <strong>Registration as a user will enable Advisers to create, submit and track application progress.</strong>
          </p>
          <p class="normal">
            Completion of this on-line registration will take approximately 5 minutes.
          </p>
        </div>
        
        <h2>Enter the AFSL of your Dealer Group</h2>
        
        <form method="post">
          <div class="form-group">
            <div class="form-row last-row">
              <tag:formField2Col name="AFSL" path="dealergroup.afsl" id="afsl" dimension="short" mand="true" />
            </div>
          ...
          <div class="button-row">
            <button name="next" type="submit">Proceed</button>
