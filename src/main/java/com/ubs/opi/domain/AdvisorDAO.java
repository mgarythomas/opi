 ...
 * @see com.ubs.opi.domain.Advisor
...
//   public boolean doesAdvisorHaveApplications(Long advisorId) {
//     List values = super.getHibernateTemplate().find("select count(*) from Advisor as advisor where advisor.id = ? and advisor.applications is empty", advisorId);
//     
...
//   }
   ...
   public static void main(String args[]) {
     ApplicationContext applicationContext = new ClassPathXmlApplicationContext(
         new String[] {
             "classpath:/com/ubs/opi/applicationContext-hibernate.xml"
         });
     
     AdvisorDAO advisorDAO = (AdvisorDAO) applicationContext.getBean("AdvisorDAO");
     
     System.out.println(advisorDAO.doesNotAdvisorHaveApplications(4321L));
   }
   ...
   public void delete(Advisor persistentInstance) {
    ...
    public Advisor findById(Long id) {
        ...
        try {
            Advisor instance = (Advisor) getHibernateTemplate().get("com.ubs.opi.domain.Advisor", id);
            return instance;
        } catch (RuntimeException re) {
