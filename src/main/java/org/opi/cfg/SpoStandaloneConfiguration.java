...
public class SpoStandaloneConfiguration {

	final private Logger logger = LoggerFactory
			.getLogger(SpoStandaloneConfiguration.class);
	...
	@PostConstruct
	public void populateJNDI() {
		logger.debug("Setting JNDI Context");
		SimpleNamingContextBuilder builder = new SimpleNamingContextBuilder();
		builder.bind(getJndiName(), getDataSource());
	}
