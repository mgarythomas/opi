...
public class OpiMailManager implements MailManager {
   ...
   public void resendUserNameandPassword(Individual individual) {
      ...
      buff.append("</p>");
      buff.append("<p>");
      buff.append("To access the Online Application Service please visit our website at: <a href='http://polar-ocean-5856.herokuapp.com/opi/'>http://polar-ocean-5856.herokuapp.com/opi/</a>.");
      buff.append("</p>");
      buff.append("<p>");
      ...
      try {
         ...
         InternetAddress from = new InternetAddress("paul@laserandcosmetic.com", "Online Application Service");
         helper.setFrom(from);
    ...
    * (non-Javadoc)
    * 
    * @see org.opi.service.MailManager#sendUserNameandPassword(org.opi.domain.Advisor)
    */
